...
* Complete executable reproducer: [reproducer/](https://github.com/WilliePim/camunda7-portability-inventory/tree/main/reproducer), a Maven project with an embedded engine on in-memory H2 ([how to run it](https://github.com/WilliePim/camunda7-portability-inventory/blob/main/reproducer/README.md#run)). With `JAVA_HOME` pointing to a JDK 21: `git clone https://github.com/WilliePim/camunda7-portability-inventory.git camunda7-portability-inventory && cd camunda7-portability-inventory/reproducer && ./mvnw test -Dtest=Bug01SignalTenantRestrictionTest`
